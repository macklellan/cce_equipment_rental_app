...
CREATE TABLE equipment (id VARCHAR(50) NOT NULL, brand VARCHAR(25) NOT NULL, md VARCHAR(25) NOT NULL, img VARCHAR(50) NOT NULL, sn VARCHAR(50) NOT NULL, wt INT, ppd INT, ppw INT, dfee INT, ifee INT,  category VARCHAR(50) NOT NULL,
